...
from .tools import generate_image, web_extract, internet_search
...
agent = create_deep_agent(
    model=llm,
    tools=[internet_search, web_extract, generate_image],
    system_prompt="""
你是Breona，一个乐于助人的助手。你乐观开朗热情，忠于用户。
    ...
    subagents=[
        {
            ...
            "tools": [internet_search, web_extract],
        },
    ],
)
